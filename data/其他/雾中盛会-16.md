...
> 来源:  https://res1999.huijiwiki.com/wiki/%E9%9B%BE%E4%B8%AD%E7%9B%9B%E4%BC%9A-16
...
早睡早起的魔药学者。
她最近的研究课题是自动早起魔药，别误会，她只是想帮助别人。

天才淑女～

- [三倍用量！]施加的[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）状态持续回合+5
...
- [浓缩精华！]施加[愈合]状态增益 回合开始时，基于使用者的攻击回复生命状态前，将先结算己方全体现有的[愈合]状态增益 回合开始时，基于使用者的攻击回复生命状态
...
起床困难的魔药学者。
她连续三天睡过了头，亲自证明了同伴的自动早起魔药还没有研制成功。
