...
> 来源:  https://res1999.huijiwiki.com/wiki/Sim-21
...
[我方]每回合第一个行动的角色，获得嘲讽1回合；每回合第二个行动的角色获得一层[坚韧]被动 受创减免+5%（最多叠加10层）；第三个行动的角色获得一层[强击]被动 创伤加成+4%（最多叠加10层）
...
- 攻击命中时，赋予目标一层[破坏]状态异常 叠加3层时，陷入[破碎]状态异常 受创减免-40%状态2回合

诅咒保护C

- 回合开始时，若生命低于70%，行动点+1，受创减免+60%；回合开始时，若生命低于30%，行动点+1，创伤加成+60%
