...
> 来源:  https://res1999.huijiwiki.com/wiki/PT-22
...
[图: https://huiji-thumb.huijistatic.com/res1999/uploads/thumb/a/a0/MonsterHeadIcon-307101.png/50px-MonsterHeadIcon-307101.png]
...
[图: https://huiji-public.huijistatic.com/res1999/uploads/d/d6/Spine_static-307101_kanjila.png]
...
- 回合结束时，若本回合未受到攻击，则赋予其他友方[玛瑙运势]状态增益 [流浪之歌与舞]获得强化（不可驱散）
...
[图: https://huiji-public.huijistatic.com/res1999/uploads/f/f9/Skill-30710131.png]
...
[图: https://huiji-thumb.huijistatic.com/res1999/uploads/thumb/3/30/Skill-30710111.png/66px-Skill-30710111.png]
...
单体攻击，造成150%精神创伤；命中时使其陷入[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）状态2回合，每回合结束时，对其造成使用者攻击*30%的本源创伤；处于[翡翠运势]状态增益 [嘿，喷吉！]获得强化（不可驱散）时额外赋予目标1个相同[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）
单体攻击，造成250%精神创伤；命中时使其陷入[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）状态2回合，每回合结束时，对其造成使用者攻击*30%的本源创伤；处于[翡翠运势]状态增益 [嘿，喷吉！]获得强化（不可驱散）时额外赋予目标1个相同[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）
单体攻击，造成450%精神创伤；命中时使其陷入[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）状态2回合，每回合结束时，对其造成使用者攻击*30%的本源创伤；处于[翡翠运势]状态增益 [嘿，喷吉！]获得强化（不可驱散）时额外赋予目标1个相同[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）

[图: https://huiji-thumb.huijistatic.com/res1999/uploads/thumb/b/bc/Bg_diandian.png/18px-Bg_diandian.png]

[图: https://huiji-public.huijistatic.com/res1999/uploads/7/75/Card001.png]

[图: https://huiji-thumb.huijistatic.com/res1999/uploads/thumb/d/d6/Skill-30710121.png/66px-Skill-30710121.png]
...
单体攻击，造成200%精神创伤；处于[明珠运势]状态增益 [噢，占卜！]获得强化（不可驱散）时额外赋予目标1层[明昧]状态异常 抗暴率-25%（效果可叠加，每层时间独立计算）
单体攻击，造成300%精神创伤；处于[明珠运势]状态增益 [噢，占卜！]获得强化（不可驱散）时额外赋予目标1层[明昧]状态异常 抗暴率-25%（效果可叠加，每层时间独立计算）
单体攻击，造成500%精神创伤；处于[明珠运势]状态增益 [噢，占卜！]获得强化（不可驱散）时额外赋予目标1层[明昧]状态异常 抗暴率-25%（效果可叠加，每层时间独立计算）
...
- 回合结束时，若本回合未受到攻击，则赋予其他友方[明珠运势]状态增益 [噢，占卜！]获得强化（不可驱散）
...
- 回合结束时，若本回合未受到攻击，则赋予其他友方[翡翠运势]状态增益 [嘿，喷吉！]获得强化（不可驱散）
