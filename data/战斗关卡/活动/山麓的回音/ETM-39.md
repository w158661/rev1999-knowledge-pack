...
> 来源:  https://res1999.huijiwiki.com/wiki/ETM-39
...
- 攻击时自身处于[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）状态，造成伤害提升30%

致命病原体

- 攻击命中时，使目标陷入[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）状态2回合，回合结束时受到攻击*30%的本源创伤
...
- 回合结束时，若自身处于[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）状态，回复自身15%已损失生命
