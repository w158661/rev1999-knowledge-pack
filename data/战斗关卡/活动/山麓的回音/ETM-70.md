...
> 来源:  https://res1999.huijiwiki.com/wiki/ETM-70
...
- 攻击时若自身负面状态种类大于等于4，造成伤害降低25%；回合开始时，随机净化自身1种负面状态
...
单体攻击，造成300%现实创伤；使己方全体获得敌方攻击最高角色的所有[属性提升]状态；进入[守护者之心]吟诵 若回合开始时仍处于该吟诵状态，使用咒语：自我增强，赋予自身最大生命*20%的[护盾]，持续2回合（吟诵时受到伤害提升25%，无法行动，本次咒语不视为额外行动，受到至终的仪式攻击后解除）状态1回合
...
群体攻击，对2名敌方造成150%现实创伤；赋予自身1层[倾力]状态增益 造成伤害提升5%（可以叠加，最多叠加50层，不可驱散）
...
群体攻击，对2名敌方造成120%现实创伤；命中时赋予目标1层[虚弱]状态异常 攻击时，创伤加成-25%（生效后减少1层）
