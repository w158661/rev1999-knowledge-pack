...
> 来源:  https://res1999.huijiwiki.com/wiki/ETM-86
...
- 奇数回合结束时，陷入[噩梦]控制 无法行动，受到任意攻击后解除状态1回合；回合开始时若处于[噩梦]控制 无法行动，受到任意攻击后解除状态，则回复10%已损失生命；处于[噩梦]控制 无法行动，受到任意攻击后解除状态受到攻击时，获得2层[倾力]状态增益 造成伤害提升5%（可以叠加，最多叠加50层，不可驱散）
...
- 偶数回合结束时，陷入[噩梦]控制 无法行动，受到任意攻击后解除状态1回合；回合开始时若处于[噩梦]控制 无法行动，受到任意攻击后解除状态，则回复10%已损失生命；处于[噩梦]控制 无法行动，受到任意攻击后解除状态受到攻击时，获得2层[倾力]状态增益 造成伤害提升5%（可以叠加，最多叠加50层，不可驱散）
...
群体攻击，对敌方全体造成250%现实创伤，命中时赋予1层[麻痹]状态异常 叠加到2层时，变为眩晕或使已存在的眩晕持续时间+1
