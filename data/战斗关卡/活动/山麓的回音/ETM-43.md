...
> 来源:  https://res1999.huijiwiki.com/wiki/ETM-43
...
- 回合结束时，若自身处于[燃烧]状态异常 受到治疗效果降低15%（效果不叠加)；回合结束时受到基于携带者攻击*4%的本源创伤（效果可叠加，最多可叠加30层，多层燃烧仅视为1个[状态异常]，生效后扣除一半层数)状态，自身激情+1
...
群体攻击，对敌方全体造成350%现实创伤，若目标携带10层及以上[燃烧]状态异常 受到治疗效果降低15%（效果不叠加)；回合结束时受到基于携带者攻击*4%的本源创伤（效果可叠加，最多可叠加30层，多层燃烧仅视为1个[状态异常]，生效后扣除一半层数)，则本次攻击造成伤害额外提升30%
...
单体攻击，造成180%现实创伤；命中时赋予目标2层[燃烧]状态异常 受到治疗效果降低15%（效果不叠加)；回合结束时受到基于携带者攻击*4%的本源创伤（效果可叠加，最多可叠加30层，多层燃烧仅视为1个[状态异常]，生效后扣除一半层数)
单体攻击，造成280%现实创伤；命中时赋予目标2层[燃烧]状态异常 受到治疗效果降低15%（效果不叠加)；回合结束时受到基于携带者攻击*4%的本源创伤（效果可叠加，最多可叠加30层，多层燃烧仅视为1个[状态异常]，生效后扣除一半层数)
...
单体攻击，造成180%现实创伤；赋予自身3层[预燃]状态增益 攻击前每有1层则赋予目标1层[燃烧]状态异常 受到治疗效果降低15%（效果不叠加)；回合结束时受到基于携带者攻击*4%的本源创伤（效果可叠加，最多可叠加30层，多层燃烧仅视为1个[状态异常]，生效后扣除一半层数)（生效后全部移除）
单体攻击，造成280%现实创伤；赋予自身3层[预燃]状态增益 攻击前每有1层则赋予目标1层[燃烧]状态异常 受到治疗效果降低15%（效果不叠加)；回合结束时受到基于携带者攻击*4%的本源创伤（效果可叠加，最多可叠加30层，多层燃烧仅视为1个[状态异常]，生效后扣除一半层数)（生效后全部移除）
