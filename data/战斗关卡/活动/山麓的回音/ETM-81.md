...
> 来源:  https://res1999.huijiwiki.com/wiki/ETM-81
...
- 每2回合开始时，进入[灾厄孕育]若回合开始时仍处于该吟诵状态，使用咒语：群体减益，随机赋予敌方全体2种负面状态（吟诵时无法行动，本次咒语不视为额外行动，受到至终的仪式攻击后解除）状态1回合
...
- 攻击后获得2层[倾力]状态增益 造成伤害提升5%（可以叠加，最多叠加50层，不可驱散）

能量流失

- 受到攻击后获得1层[流失·倾力]特殊 回合结束时，己方角色失去1层[倾力]状态增益 造成伤害提升5%（可以叠加，最多叠加50层，不可驱散）（可以叠加，不可驱散），若处于[中毒]状态异常 回合结束时，受到基于释放者攻击的本源创伤（可以叠加）状态，额外获得1层[流失·倾力]特殊 回合结束时，己方角色失去1层[倾力]状态增益 造成伤害提升5%（可以叠加，最多叠加50层，不可驱散）（可以叠加，不可驱散）
...
群体攻击，对敌方全体造成300%精神创伤；使自身进入[守护者之心]吟诵 若回合开始时仍处于该吟诵状态，使用咒语：自我增强，赋予自身最大生命*20%的[护盾]，持续2回合（吟诵时受到伤害提升25%，无法行动，本次咒语不视为额外行动，受到至终的仪式攻击后解除）状态1回合
