...
> **v2.1.0** ｜ 6232 数据文件 / 8 个技能 / 51 份深度扩充 / 10 模型适配卡
...
| 扩充 | 51 | 深度精读扩充卷（剧情/角色/系统/风格/模型适配研究/战斗关卡汇总；目录另含3份实测报告） |
| 战斗关卡 | 1836 | 主线296/支线475/活动649/轩事198/角色剧情65/材料关卡47/模式106（深读索引见扩充34） |
...
| 鬃毛邮报 | 75 | 游戏模式 |
| 剧情时间线 | 31 | 官方时间线 |
| 人工梦游 | 463 | 浅眠域10/深眠域371/醒梦域68/怪梦栖所12+links |
| 其他 | 2236 | 剧情文本、战斗数据、心相/头像/征集道具、雨前漫游指南3.4等 |
| 造像 | 133 | 角色造像道具页 |
| 第三扇门 | 5 | 隐藏故事 |
| 恢奇牌儿 | 5 | 成就系统 |
| 收藏品 | 3 | 收藏系统 |
...
| 律的调校 | 1 | 调律系统 |
| 局外演绎 | 1 | 塞梅尔维斯叙事 |
| 合计 | 6232 | 2026-08-11 实测 Get-ChildItem 口径；另含 data/ 顶层 skill_*.md 15个、analysis_*.txt 16个、3份实测报告（全量6235） |
...
`data/扩充/` 为深度精读扩充卷（51个文件），由各"深读官"对原始数据逐文件精读整理而成，定位为知识文档（skill_*.md）的深度补充。引用规范：扩充文档每条信息均标注原始出处文件，与已有文档冲突处如实标注、不擅自定对错。
...
| 23_其他深度全解_A~F.md | 其他目录2236文件全量深度索引（A~F篇） |
| 24_造像深度全解.md | 造像系统133页全量深度全解 |
| 25_人工梦游深度全解_浅眠深眠.md | 人工梦游浅眠域10/深眠域371页全量精读 |
| 26_人工梦游深度全解_怪梦栖所.md | 人工梦游·怪梦栖所深度全解 |
| 27_新增数据冲突报告.md | 新增数据冲突交叉验证报告 |
| 28_主线关卡深度全解_A~D.md | 主线296关深读（1~13章+5SP，敌人/奖励/剧情碎片） |
| 29_支线关卡深度全解_A~F.md | 支线475关深读（A~F六批全覆盖，F卷补齐LEE-01~23） |
| 30_活动关卡深度全解_A~D.md | 活动649关深读（A~D四批，含UTTU系数值奖励） |
| 31_轩事关卡深度全解_A~B.md | 轩事198关深读（A/B卷，TSR与DC为首次收录） |
| 32_角色剧情与材料关卡全解.md | 角色剧情65关+材料关卡47关全量 |
| 33_模式关卡深度全解.md | 模式106关深读（教学/模拟/特殊/人工梦游） |
| 34_战斗关卡汇总索引.md | 战斗关卡全局汇总（前缀映射/统计/敌人/BOSS/掉落/查询指引） |
