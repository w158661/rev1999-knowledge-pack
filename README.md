...
> **v2.1.0** ｜ 6231+ 数据文件 / 8 个技能 / 50 份深度扩充 / 10 模型适配卡
...
| 扩充 | 50 | 深度精读扩充卷（剧情/角色/系统/风格/模型适配研究/战斗关卡汇总） |
...
`data/扩充/` 为深度精读扩充卷（50个文件），由各"深读官"对原始数据逐文件精读整理而成，定位为知识文档（skill_*.md）的深度补充。引用规范：扩充文档每条信息均标注原始出处文件，与已有文档冲突处如实标注、不擅自定对错。
...
| 29_支线关卡深度全解_A~E.md | 支线475关深读（覆盖452关，A~E五批） |
